Wersja promptu: 5 (2026-08-23 — dodano `wystapien` do każdej formy w `udzial_forma`: licznik NIEZALEŻNY od `przyklady` (który zostaje ucięty na 3 wpisach) — bez osobnego licznika sekcja "Rodzaj udziału w obradach" nie miała jak pokazać proporcji między odczytaniem/czynnością formalną/dyskusją, tylko fakt, że każda się zdarzyła)
