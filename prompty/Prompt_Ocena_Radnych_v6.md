Wersja promptu: 6 (2026-08-22 — nowa sekcja: główne obszary zainteresowania radnego, maks. trzy tematy z przybliżonym udziałem procentowym liczonym z wypowiedzi i spraw, z jawnym zastrzeżeniem gdy materiału jest za mało albo tematy są zbyt rozproszone, by wskazać dominujący obszar)
...
- Nie porównuj radnego z innymi radnymi i nie sugeruj, czy czegoś jest dużo, czy mało. Liczby (ile wypowiedzi, ile minut) są wyliczane gdzie indziej — tu ich nie podajesz i nie szacujesz, z jednym wyjątkiem: procentowy udział obszarów w sekcji "Główne obszary zainteresowania", tam liczysz go tak, jak opisano w FORMACIE.
